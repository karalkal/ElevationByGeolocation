...
// http://api.geonames.org/postalCodeSearchJSON?placename=sofia&country=bg&maxRows=10&username=kurcho
$url = 'http://api.geonames.org/postalCodeSearchJSON?maxRows=500&placename=' . $_REQUEST['placename'] . '&country=' . $_REQUEST['country'] . '&username=kurcho';
